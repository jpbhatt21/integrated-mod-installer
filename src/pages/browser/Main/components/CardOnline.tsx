	...
	return (
		<div className="card-generic card-online ">
			<div className="min-h-full static">
				<img
					className="fadein flex flex-col relative min-h-full top-0 items-center justify-center object-cover w-full duration-200 bg-center bg-no-repeat rounded-lg pointer-events-none"
					src={backgroundImage}
				...
				/>
				<img
					className="w-full fadein min-h-[calc(100%-3.5rem)] relative -translate-y-[100%] -top-14 duration-200 rounded-lg pointer-events-none object-cover fadein flex flex-col items-center justify-center bg-center bg-no-repeat"
					src={backgroundImage}
			...
			<div
				className={`w-fit fadein bg-background/50 text-accent  backdrop-blur-sm -mt-68 flex flex-col items-center px-4 py-1 mb-44 rounded-tl-lg rounded-br-lg pointer-events-none`}
			>
				{data._sModelName}
			</div>

			<div className={`bg-background/50 fadein backdrop-blur-sm rounded-b-lg flex flex-col items-center w-full px-4 py-1`}>
				<Input
					readOnly
					type="text"
